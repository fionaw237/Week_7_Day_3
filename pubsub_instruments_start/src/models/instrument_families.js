...
InstrumentFamilies.prototype.bindEvents = function(){
  ...
  PubSub.subscribe('InputView:item-clicked', (event) => {
    const familyName = event.detail;
    const familyObject = this.findByName(familyName)
    PubSub.publish('InstrumentFamilies:family-ready', familyObject);
  })
}

InstrumentFamilies.prototype.findByName = function(name){
  return this.instrumentFamilies.find((family) => {
